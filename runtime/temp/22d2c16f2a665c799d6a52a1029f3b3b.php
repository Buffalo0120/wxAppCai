<?php /*a:2:{s:56:"D:\project\erha\themes/pc/miniapp/guess_option\list.html";i:1551516363;s:50:"D:\project\erha\themes/pc/miniapp/common\base.html";i:1551446749;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form action="" class="layui-form" method="get">
    <label class="layui-form-label">
        <a href="<?php echo url('guess_option/add',['q_id' => $q_id]); ?>" class="layui-btn layui-btn-sm layui-btn-normal"  >添加</a>
    </label>
</form>
<div>
        ...
        <table class="layui-table" lay-skin="line">
            ...
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <?php if($v['right_option'] == $v['id']): ?>
                        是
                        <?php else: ?>
                        <a class="layui-btn layui-btn-sm layui-btn-normal"
                            href="<?php echo url('guess_option/set',['id'=>$v['id'],'q_id'=>$q_id]); ?>">设为正确答案</a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <a href="<?php echo url('guess_option/edit',['id'=>$v['id'],'q_id'=>$q_id]); ?>"
...
<script>
    ...
    function aa(id)
    {
        layer.confirm('确定删除吗？',{btn:['确定','取消']},function(res){
            $.post("<?php echo url('guess_option/del'); ?>",{id:id},function (res) {
                if(res.status=='0'){
                    layer.msg(res.msg);
                }
                if(res.status=='1'){
