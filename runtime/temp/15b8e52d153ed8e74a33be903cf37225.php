<?php /*a:2:{s:49:"D:\project\erha\themes/pc/mp/index\upminiapp.html";i:1547704070;s:54:"D:\project\erha\themes/pc/mp/..\admin\common\base.html";i:1547704070;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="layui-form" method="post" style="padding-right: 10px;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" value="<?php echo htmlentities($miniapp['name']); ?>" required lay-verify="required" placeholder="请输入小程序名称" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" <?php if($miniapp['type'] == '1'): ?> checked <?php endif; ?>  name="type" value="1" title="认证小程序">
            <input type="radio" <?php if($miniapp['type'] == '2'): ?> checked <?php endif; ?> name="type" value="2" title="普通小程序">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">APPID</label>
        <div class="layui-input-block">
            <input type="text" name="appid" value="<?php echo htmlentities($miniapp['appid']); ?>" required lay-verify="required" placeholder="请输入APPID" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="appsecret" value="<?php echo htmlentities($miniapp['appsecret']); ?>" required lay-verify="required" placeholder="请输入APPSECRET"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="origin_id" value="<?php echo htmlentities($miniapp['origin_id']); ?>"  placeholder="请输入原始ID" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <?php echo hook('Upload',['type'=>'image','name'=>'logo','value'=>$miniapp['logo']]); ?>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">二维码</label>
        <div class="layui-input-block">
            <?php echo hook('Upload',['type'=>'image','name'=>'qrcode','value'=>$miniapp['qrcode']]); ?>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">描述</label>
        <div class="layui-input-block">
            <textarea name="desc"  placeholder="请输入小程序描述" class="layui-textarea"><?php echo htmlentities($miniapp['desc']); ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">开关状态</label>
        <div class="layui-input-block">
            <input name="status" value="1" <?php if($miniapp['status'] == '1'): ?> checked <?php endif; ?>  title="开启"  type="radio">
            <input name="status" value="0" <?php if($miniapp['status'] == '0'): ?> checked <?php endif; ?> title="关闭" type="radio">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">关闭回复</label>
        <div class="layui-input-block">
            <textarea name="close_msg" placeholder="请输入关闭回复" class="layui-textarea"><?php echo htmlentities($miniapp['close_msg']); ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
            <input name="id" type="hidden" value="<?php echo htmlentities($miniapp['id']); ?>">
