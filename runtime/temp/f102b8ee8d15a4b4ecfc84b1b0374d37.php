<?php /*a:2:{s:68:"D:\project\erha\themes/pc/miniapp/guess_question\guess_question.html";i:1551448534;s:50:"D:\project\erha\themes/pc/miniapp/common\base.html";i:1551446749;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <form class="layui-form" action="" style="padding: 0px 10px 0px 10px;">
        <table class="layui-table" lay-skin="line">
            ...
            <tr>
                ...
                <td><?php echo htmlentities(date("Y-m-d",!is_numeric($v['start_time'])? strtotime($v['start_time']) : $v['start_time'])); ?></td>
                <td><?php echo htmlentities(date("Y-m-d",!is_numeric($v['stop_time'])? strtotime($v['stop_time']) : $v['stop_time'])); ?></td>
                <td><?php echo htmlentities(substr($v['update_time'],"10")); ?></td>
                <td></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
